...
import { RiSettingsLine, RiHome3Line, RiChatSmile2Line } from 'react-icons/ri';
    ...
    <div className="bg-[#393E46] text-[#B8B9BC] rounded-[15px]">
      <div className="min-w-max max-w-xl w-[80px] max-h-full min-h-full relative flex justify-center">
        <div className="py-8 flex flex-col gap-8">
          <Link href="/home">
            <div className={router?.pathname === '/home' ? 'bg-[#00ADB5] text-[#EEEEEE] flex justify-center p-2.5 rounded-[10px]' : ''}>
              <RiHome3Line
                size={router?.pathname === '/home' ? 20 : 30}
              />
            </div>
          </Link>
          <Link href="/chat">
            <div className={router?.pathname === '/chat' ? 'bg-[#00ADB5] text-[#EEEEEE] flex justify-center p-2.5 rounded-[10px]' : 'flex justify-center'}>
              <RiChatSmile2Line size={router?.pathname === '/chat' ? 20 : 30} />
            </div>
          </Link>
          <Link href="/setting">
            <div className={router?.pathname === '/setting' ? 'bg-[#00ADB5] text-[#EEEEEE] flex justify-center p-2.5 rounded-[10px]' : 'flex justify-center'}>
